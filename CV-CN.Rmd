...
position: 数学与统计专业 硕士研究生在读；统计专业 一等荣誉学士；金融、信息系统专业 学士
address: 澳大利亚 维多利亚州
...
tribble(
  ...
  list(
    "获得留学生奖学金（约合70000元）。",
    "主修数学统计、计算统计、多元变量统计、贝叶斯统计学习、测度概率论、非参数统计建模等课程。",
...
tribble(
  ...
  "\\href{https://github.com/iNZightVIT/iNZightTS}{iNZightTS}", "2022", "作者",
  "为奥克兰大学统计系的iNZightVIT软件项目提供可视化与建模分析时间序列的R编程包。",
  "\\href{https://github.com/iNZightVIT/iNZightTools}{iNZightTools}", "2023", "作者",
